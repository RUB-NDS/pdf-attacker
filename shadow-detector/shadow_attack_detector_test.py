...
class Test_ShadowAttackDetector(unittest.TestCase):
    ...
    def test_shadow_hide_form(self):
        self.assertEqual(preventor("./shadow-demo-exploits/hide/variant-1_hide-via-referenced-object/2_original-document-shadowed.pdf"), 2)
        self.assertEqual(preventor("./shadow-demo-exploits/hide/variant-1_hide-via-referenced-object/3_original-document-shadowed-signed.pdf"), 2)
    ...
    def test_shadow_hide_form_and_text1(self):
        ...
        self.assertEqual(shadow_hide_form_detector("./shadow-demo-exploits/hide-and-replace/variant-2_change_objects_usage/4_original-document-shadowed-signed-manipulated.pdf"), 0)
        ...
        self.assertEqual(shadow_hide_and_hide_replace_detector("./shadow-demo-exploits/hide-and-replace/variant-2_change_objects_usage/4_original-document-shadowed-signed-manipulated.pdf"), 0)
    ...
    def test_shadow_hide_and_replace(self):
        self.assertEqual(preventor("./shadow-demo-exploits/replace/variant-1_replace-via-overlay/2_original-document-shadowed.pdf"), 13)
        self.assertEqual(preventor("./shadow-demo-exploits/replace/variant-1_replace-via-overlay/3_original-document-shadowed-signed.pdf"), 15)
        self.assertEqual(shadow_hide_and_hide_replace_detector("./shadow-demo-exploits/replace/variant-1_replace-via-overlay/4_original-document-shadowed-signed-manipulated.pdf"), 14)
...
class Test_ShadowAttackDetectorIntegration(unittest.TestCase):
    ...
    def test_start_preventor_detector_with_manipulated_hide_form(self):
        ...
        self.assertGreater(start_preventor_detector("./shadow-demo-exploits/hide/variant-1_hide-via-referenced-object/1_original-document.pdf"), 0)
    ...
    def test_start_preventor_detector_with_manipulated_hide_form_and_text(self):
        ...
        self.assertGreater(start_preventor_detector(".//workspaces/pdf-attacker/shadow-demo-exploits/hide/variant-2_hide-via-referenced-object/hide-form-via-form/3_original-document-shadowed-signed.pdf"), 0)
    ...
    def test_start_preventor_detector_with_manipulated_replace_font(self):
        self.assertEquals(start_preventor_detector("./shadow-demo-exploits/replace/variant-2_replace-via-overwrite/3_original-document-shadowed-signed.pdf"), 0)
        self.assertGreater(start_preventor_detector("./shadow-demo-exploits/replace/variant-2_replace-via-overwrite/4_original-document-shadowed-signed-manipulated.pdf"), 0)
